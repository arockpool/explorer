<template>
 <div class='personalCenter mb-3'>
    <!-- <p class='text-xl lg:mt-14 lg:mb-10 my-6 text-2xl'>{{$t('Lang.Personal Center')}}</p>   -->
    <p class='hidden lg:block text-2xl mb-3'>{{$t('Lang.Personal Center')}}</p>
    <!-- <div class='lg:hidden block mb-2'>
    ...
    <el-dialog
      ...
      <el-form label-position="top" label-width="80px" ref="passwordForm"  size="mini" :model="passwordForm" :rules="passwordRules">
        <!-- <el-form-item :label="$t('Lang.Original login password')" prop="old_password">
          <el-input @focus='inputFocus' clearable v-model="passwordForm.old_password" class="login-el-input" :placeholder="$t('Lang.Please enter the original login password')" type="password" show-password clearable></el-input>
        </el-form-item> -->
    ...
    <el-dialog
      ...
      <div class='flex items-start justify-between'>
        <ul class="flex justify-left   mb-6">
          ...
          >
            ...
            <!-- <i class="el-icon-delete ml-1 cursor-pointer" @click='delPhoneNum(item)'></i> -->
      ...
      <div class='mt-6'  v-show="acitveLable !== defaultMobile">
        <!-- <p class='mb-4 text-base' v-show="!addFlag">替换当前手机号：</p>
        <p class='mb-4' v-show="addFlag">新增手机号：</p> -->
        <!-- <el-input class="login-el-input" :placeholder="$t('Lang.Please enter')" v-model="nodeMsgPhone" clearable> </el-input> -->
...
export default {
  ...
  methods: {
    ...
    passwordOk() {
      ...
      //   this.errorMsg = "Lang.Please enter the original login password";
      //   return;
      // }
      ...
      // if(!/^([1-9]\d*|0)(\.\d{1,})?$/.test(this.passwordForm.verification_code)){
      //   this.errorMsg = '验证码只能是数字'
      //   return
      // }
