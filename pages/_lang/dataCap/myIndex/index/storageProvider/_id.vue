            ...
            <table class="table-fixed w-full">
              <thead>
                <tr class="">
                  ...
                  <!-- <th class="w-1/12 py-4 font-bold text-6C757E">{{$t('Lang.Tag')}}</th> -->
                  ...
                  <!-- <td class="w-1/12 py-3 text-center truncate">
                    <template v-if="globalMinerTag[item.miner_no]">
                      ...
                      <el-popover trigger="hover" :content="$t('Lang.The user has completed signature verification for the owner')">
                        <img v-show="globalMinerTag[item.miner_no].signed" src="@/assets/imgs/isSigned.png"  alt="" class='ml-2'  style='width:12px; height:12px' slot="reference">
                      </el-popover>
                    </template>
                    <span v-else>-</span>
                  </td> -->
