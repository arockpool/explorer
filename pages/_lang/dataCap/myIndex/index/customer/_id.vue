      ...
      <div class="mb-3" v-show="objs.length !== 0" >
            ...
            <table class="table-fixed w-full">
              <thead>
                <tr class="">
                  ...
                  <!-- <th class="w-1/12 py-4 font-bold text-6C757E">{{$t('Lang.Datacap share')}}</th> -->
              ...
              <tbody>
                <tr v-for="(item, index) in objs" class="border-b border-solid border-E8E7EB" :key="index + '_index'">
                  ...
                  <!-- <td class="w-1/12 py-3 text-center truncate">{{(item.allocated_allowance - item.use_allowance) | formatPower(2)[0]}} {{(item.allocated_allowance - item.use_allowance) | formatPower(2)[1]}}</td> -->
                  <td class="w-1/12 py-3 text-center truncate">
          ...
          <div class="lg:hidden bg-white"  v-loading="loading">
            <div v-for="(item, index) in objs" class="p-3 mb-3 bg-white rounded-md border border-solid border-E8E7EB" :key="index + '_index'">
              ...
              <!-- <div class="flex items-center justify-between pb-1">
                <span class="flex-1">{{$t('Lang.Datacap share')}}</span>
                <div class="w-1/2 text-right truncate">
              ...
              <!-- <div class="flex items-center justify-between pb-1">
                ...
                <div class="w-1/2 text-right truncate">
                  {{(item.allocated_allowance - item.use_allowance) | formatPower(2)[0]}} {{(item.allocated_allowance - item.use_allowance) | formatPower(2)[1]}}
                </div>
              </div> -->
              <div class="flex items-center justify-between pb-1">
    ...
    getexcel(){
      this.$axios.post('/api/explorer/get_plus_client_list', {
        ...
        this.json_data.map(i=>{
          // let num = i.allocated_allowance - i.use_allowance
