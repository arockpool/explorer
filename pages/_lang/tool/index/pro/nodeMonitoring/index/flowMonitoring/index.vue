      ...
      <div class='lg:block hidden'>
        <table class="table-fixed w-full">
          ...
          <tr class="">
            ...
            <th class="w-10 py-4 font-medium mr-4">{{$t('Lang.Types')}}</th>
            ...
            <th class="w-10 py-4 font-medium mr-4">{{$t('Lang.Operating')}}</th>
          ...
          <tr v-for="(item, index) in rawPowerList" class="border-t border-solid border-E8E7EB" :key="index + '_index'">
            ...
            <td class="w-1/12 py-3 text-center truncate" >
               {{$t('Lang.More than the')}} {{Number(item.value).toFixed(0)}} F
            </td>
    ...
    <el-dialog
      ...
      <el-form label-position="top" label-width="80px" ref="editForm"  size="mini" :model="editForm" :rules="editRules">
        ...
        <el-form-item :label="$t('Lang.Early warning threshold')" prop="value">
          ...
          <span>{{$t('Lang.More than the')}}</span>
...
export default {
  ...
  methods: {
    ...
    edit(item) {
      this.formError = "";
      this.title = "Lang.Modify fund flow monitoring";
      ...
      this.editForm.value = Number(item.value).toFixed(2);
    ...
    editOK() {
      ...
      if(this.title == 'Lang.Add fund flow monitoring'){
    ...
    addNode() {
      ...
      this.title = "Lang.Add fund flow monitoring";
      this.editForm.miner_no = "";
      this.editForm.remarks = "";
      this.editForm.value = 100;
      this.editForm.warn_mobile_ids = [];
      this.formError = "";
