    ...
    <div id='effectiveShareBox' ref="effectiveShareBox" class='text-white'>
      <div class="effectiveShareTop ">
        <div class='mb-2 mx-4 mt-2 flex items-end justify-between'>
          ...
          <!-- <img class='h-6 mb-2' src="~/assets/img/icon-logo.png" /> -->
        </div>
        <div class=' mx-4 mt-2'>
      ...
      <div class='text-base bg-main px-4 pb-4 pt-2'>
        ...
        <p class='text-base'>{{$t('Lang.In the Arockpool browser')}}(arockpool.com)</p>
        <div class='flex items-center justify-between'>
          ...
          <div class='text-center'>
            ...
            <!-- <p class='text-base'>{{$t('Lang.Scan code to view')}}</p> -->
          </div>
        </div>
        <!-- <div class='flex items-start justify-between mt-8'>
          <div>
            <p class=' text-base'>{{$t('Lang.More Filecoin data')}}</p>
            <p calss='text-base'>{{$t('Lang.In the Arockpool browser')}}</p>
          </div>
          <div class='text-center'>
            <img  class='h-16' src="@/assets/imgs/WechatIMG10.png" alt="">
            <p calss='text-base'>{{$t('Lang.Scan code to view')}}</p>
          </div>
        </div>
        <img class="h-6 -mt-6" src="~/assets/img/icon-logo.png" /> -->
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    scareBtn() {
      ...
      setTimeout(() => {
        ...
        html2canvas(myBox, {
          ...
          //   utils.blobToFileDownload(blob,`满存算力产出.png`)
          // },"image/png")
    ...
    toImage() {
      ...
      // a.href = this.imgUrl;
      // a.setAttribute('download', '满存算力产出');
      // a.click();
...
// .data-handler .el-input.is-disabled .el-input__inner {
