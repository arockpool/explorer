    ...
    <div  id='machineShareBox' ref="machineShareBox" class='text-white' >
      ...
      <div class='text-base bg-main px-4 pb-4 pt-2'>
        ...
        <div class='flex items-center justify-between'>
          <!-- <img class="h-5 lg:h-6 mt-8" src="~/assets/img/icon-logo.png" /> -->
  ...
  methods: {
    calculatorHandler: async function() {
      ...
        }else{
        ...
        // 存储空间除以封装速度不能大于540  （因为扇区有效期最多只有540天）
        let maxStore = 540 * this.form.speed
        // let msg = `以当前封装速度最多可封装完成${maxStore}TiB的存储空间，请重新输入存储空间，输入值不可大于${maxStore}`
        // this.$notification.error({
        //   title: '错误',
        //   message: msg
        // })
