            ...
            <div class="left flex items-center" v-loading='enterListLoading'>
              <div v-show="enterList.length !== 0">
                <div class='flex h-20' v-for="(i,j) in enterList" :key="i.msg_address+j+'enter'">
                  ...
                  <div v-show="enterList.length == 1">
                    <!-- <img src="@/assets/imgs/walletFlow_line.png" alt="" class='h-20'> -->
                  </div>
                </div>
              </div>
            ...
            <!-- <div class="middle flex items-center">
              <div class='flex'>
                <div class='flex items-center w-30'>
                  <img src="@/assets/imgs/wallet_arrow.png" alt="">
                </div>
                <div class='py-8 px-10 rounded-lg border-dashed  border-E8E7EB border-2 text-main' style='background:#F3F4FC'>
                  <n-link :to="`/${lang}/chain/addr/${address}`" class='cursor-pointer w-40'>{{address | getSubStr}}</n-link>
                </div>
                <div class='flex items-center w-30'>
                  <div class='w-32 bg-E8E7EB' style='height:2px'></div>
                </div>
              </div>
            </div> -->
          ...
          <div>
            ...
            <div class='flex justify-center' v-loading='enterListLoading'>
              <div class='w-24' v-for="(i,j) in enterList" :key="j+'enter'" v-show="enterList.length !== 0">
                ...
                <!-- <div v-show="enterList.length ==1">
                  <img  src="@/assets/imgs/wallet_phone_line.png" alt="" class='w-full'>
                </div> -->
              </div>
            ...
            <!-- <div class='flex justify-center w-full'>
              <img src="@/assets/imgs/wallet_phone_arrow.png" alt="" class=''>
            </div> -->
            <!-- 当前钱包 -->
            <!-- <div class="middle flex justify-center">
              <div class='py-6 px-10 rounded-lg border-dashed  border-E8E7EB border-2 text-main' style='background:#F3F4FC'>
                <n-link :to="`/${lang}/chain/addr/${address}`" class='cursor-pointer w-40'>{{address | getSubStr}}</n-link>
              </div>
            </div> -->
            <!-- 箭头 -->
            <!-- <div class='flex justify-center w-full'>
              <div class='h-24 bg-E8E7EB' style='width:2px'></div>
            </div> -->
...
export default {
  ...
  methods: {
    seach(){
        ...
        if(res.data){
          // f3q2kzhc2zzwdclfj6imgiffn2xvtyfu42tz7h2gfstj7j7xjlxgefnh35dxnc3frwvpr35hgayldy6kssrt2a
            ...
            console.log('1',this.delBack,this.inputWallet);
    ...
    showMore(i,flag){
        // this.$axios.post('/api/explorer/get_wallet_message_list', {
        //     from_address:i.f1bj2gtsc7fuz5ngirxfnzzhdayjlocd65ckf3eeq,
        //     to_address:this.inputWallet,
        //     page_size:15,
        //     page_index:1,
        // }).then(res=>{
        //     console.log(res);
    ...
    backSeach(){
      // console.log(this.backSeachList);
      // console.log(this.backSeachList);
      // console.log(this.backSeachList[this.backSeachList.length-1]);
