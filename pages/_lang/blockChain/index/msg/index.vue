    ...
    <div class='block lg:flex justify-between lg:mb-4 mb-2'>
      ...
      <div class='flex items-center justify-between'>
        ...
        <div class='lg:flex hidden'>
          ...
          <!-- <div class='w-60 ml-4'>
            <el-input clearable v-model="orderSeach" size="mini" :trigger-on-focus="false" @clear='changeSelect' @change="searchChange" :placeholder="$t('Lang.Search node')">
            ...
            <table class="table-fixed w-full">
              <thead>
                <tr class="">
                  ...
                  <!-- <th class="w-1/12 py-4 font-medium text-6C757E">{{$t('Lang.Tag')}}</th> -->
                ...
                <tr v-for="(item, index) in objs" class="border-b border-solid border-E8E7EB" :key="index + '_index'">
                  ...
                  <!-- <td class="w-1/12 py-3 text-center">
                    <template v-if="globalMinerTag[item.msg_to]">
                      <span class="truncate">{{ globalMinerTag[item.msg_to].en_tag }}</span>
                      <el-popover trigger="hover" :content="$t('Lang.The user has completed signature verification for the owner')">
...
export default {
  ...
  asyncData({ app, params }) {
    ...
    // return app.$axios.post('/api/explorer/get_message_list', {
    //     page_index: 1,
    //     page_size: 20,
    //   })
    //   .then(res => {
