        ...
        <table class="table-fixed w-full">
          <thead>
            <tr class="">
              ...
              <!-- <th class="w-2/12 py-4 font-medium">{{$t('Lang.Sender')}}</th>
              <th class="w-16 py-4 font-medium"></th>
              <th class="w-2/12 py-4 font-medium">{{$t('Lang.Receiver')}}</th> -->
...
export default {
  ...
  asyncData({ app, params }) {
    ...
    // return app.$axios.post('/api/explorer/get_transfer_list', {
    //     miner_id: data.miner_no,
    //     page_size: 20,
    //     page_index: 1,
    //   })
    //   .then(res => {
    ...
    //     data.total_count = res.data.total_count > 9800 ? 9800 : res.data.total_count
    //   })
    return data
  },
