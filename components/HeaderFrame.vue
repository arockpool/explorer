    ...
    <div class="hidden editionCenter px-3 lg:block  pt-6 pb-3">
      <div class='flex justify-between '>
        ...
        <div class='flex items-center'>
          <!-- 周年简报下载 -->
          <!-- <div class='cursor-pointer ' @click='downs'>
            <img class=' -mt-3' src="@/assets/imgs/oneYearTitle.png" alt="">
          </div> -->
          ...
          <div class="h-10 ml-6 flex items-center cursor-pointer " v-show="!IsSignIn">
            <div class='flex '>
              ...
              <!-- <p class='px-2 opacity-75'>/</p> -->
              <!-- <p class='opacity-75 hover:opacity-100' @click="goLogin('account/register')">{{$t('Lang.Sign in')}}</p> -->
            </div>
          </div>
          <!-- 切换语言 -->
    ...
    <div class="block lg:hidden px-3 pt-4">
      ...
      <div class="flex items-center justify-between py-3">
        ...
        <div class="flex items-center justify-center">
          ...
          <!-- 周年简报下载 -->
          <!-- <div class='mr-4'>
            <img @click="phoneDowm" class='mb-1 w-17' src="@/assets/imgs/phoneDowmOneYear.png" alt="">
          </div> -->
          ...
          <!-- 菜单 -->
          <!-- <span class="text-3xl ml-6"   @click="menuHandler">
            <img src="../assets/imgs/operation.png" alt="" style='width:18px'>
          </span> -->
        </div>
      </div>
      <!-- 下部分搜索框 -->
...
export default {
      ...
      menuList:[
        ...
        },
        {
          ...
          subList:[
            ...
            {name:'Lang.Arock Pool',router:'/statistics/arock',pro:false},
          ]
        },
        {
          title:'工具',
  ...
  methods: {
    ...
    handleRouter(command){
      ...
      // console.log(`/${this.langimg}${command}`);
